...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vclassroom\RestrictionsRepository")
 * @ORM\Table(name="classroom_restrictions")
 */
class Restrictions implements \JsonSerializable, \Vittascience\JsonDeserializer
{
    /** 
     * @ORM\Id
