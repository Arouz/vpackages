...
namespace Vittascience\Entity\Vuser;
...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vuser\ClassroomUserRepository")
 * @ORM\Table(name="user_classroom_users")
 */
class ClassroomUser implements \JsonSerializable, \Vittascience\JsonDeserializer
{
    /**
     * @ORM\Id
