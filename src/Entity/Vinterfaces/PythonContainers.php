...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vinterfaces\PythonContainersRepository")
 * @ORM\Table(name="python_containers")
 */
class PythonContainers implements \JsonSerializable, \Vittascience\JsonDeserializer
{
    /** 
     * @ORM\Id
