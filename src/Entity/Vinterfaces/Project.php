...
use Vittascience\Entity\Vinterfaces\ExerciseStatement;
...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vinterfaces\ProjectRepository")
 * @ORM\Table(name="interfaces_projects")
 */
class Project implements \JsonSerializable, \Vittascience\JsonDeserializer
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Vittascience\Entity\Vinterfaces\ExercisePython",inversedBy="projects")
     * @ORM\JoinColumn(name="id_exercise", referencedColumnName="id")
     */
    private $exercise;

    /**
     * @ORM\ManyToOne(targetEntity="Vittascience\Entity\Vinterfaces\ExerciseStatement", cascade={"persist","remove"})
