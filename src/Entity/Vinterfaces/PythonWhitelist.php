...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vinterfaces\PythonWhitelistRepository")
 * @ORM\Table(name="python_whitelist")
 */
class PythonWhitelist implements \JsonSerializable, \Vittascience\JsonDeserializer
{
    /** 
     * @ORM\Id
