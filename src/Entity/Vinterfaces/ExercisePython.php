...
use Vittascience\Entity\Vinterfaces\Project;
...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vinterfaces\ExercisePythonRepository")
 * @ORM\Table(name="python_exercises")
 */
class ExercisePython implements \JsonSerializable, \Vittascience\JsonDeserializer
{
    /** 
     * @ORM\Id
    ...
    /**
     * @ORM\OneToMany(targetEntity="Vittascience\Entity\Vinterfaces\Project",mappedBy="exercise")
     * @var Project
     */
    private $projects;
