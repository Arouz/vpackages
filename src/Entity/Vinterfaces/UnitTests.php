...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vinterfaces\UnitTestsRepository")
 * @ORM\Table(name="python_tests")
 */
class UnitTests implements \JsonSerializable, \Vittascience\JsonDeserializer
{
    /** 
     * @ORM\Id
