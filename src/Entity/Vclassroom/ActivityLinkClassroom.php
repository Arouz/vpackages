...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vclassroom\ActivityLinkClassroomRepository")
 * @ORM\Table(name="classroom_activities_link_classroom")
 */
class ActivityLinkClassroom implements \JsonSerializable, \Vittascience\JsonDeserializer
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Vittascience\Entity\Vclassroom\Activity")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Vittascience\Entity\Vclassroom\Course")
