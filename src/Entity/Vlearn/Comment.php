...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vlearn\RepositoryComment")
...
class Comment
{
    ...
    private $user;
    /**
     * @ORM\ManyToOne(targetEntity="Vittascience\Entity\Vlearn\Comment")
    ...
    {
        $format = "Course (id: %s, user: %s, message: %s)\n";
        return sprintf($format, $this->id, $this->user, $this->message);
    }
