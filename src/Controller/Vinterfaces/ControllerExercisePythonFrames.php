    ...
    public function __construct($entityManager, $user)
    {
        ...
        $this->actions = array(
            'get_exercise_frames' => function () {
                ...
                // Verify Errors
                // Process Data
                $frames = $this->entityManager->getRepository(ExercisePythonFrames::class)->findBy(['exercise' => $exercise_id]);
            ...
            'create_exercise_frames' => function() {
                ...
                $project = $this->entityManager->getRepository(Project::class)->findOneBy(array(
                    'user' => $userId,
                    'exercise' => $exerciseId,
