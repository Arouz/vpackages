...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vclassroom\ClassroomRepository")
 * @ORM\Table(name="classrooms")
 */
class Classroom implements \JsonSerializable, \Vittascience\JsonDeserializer
{
