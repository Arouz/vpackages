...
use Vittascience\Entity\Vclassroom\UsersLinkApplicationsFromGroups;
        ...
        $this->actions = array(
            ...
            'add' => function () {
                ...
                if ($forkedActivityId != null) {
                    $fork = $this->entityManager->getRepository(Activity::class)
