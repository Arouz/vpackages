...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vlearn\RepositoryCollection")
 * @ORM\Table(name="learn_collections")
 */
class Collection implements \JsonSerializable, \Vittascience\JsonDeserializer
{
