...
use Vittascience\Entity\Vinterfaces\LtiProject;
...
use Vittascience\Entity\Vinterfaces\ExercisePythonFrames;
    ...
    public function __construct($entityManager, $user)
    {
        ...
        $this->actions = array(
            ...
            'get_all_user_projects' => function ($data) {
                ...
                $userFetched = $this->entityManager->getRepository(User::class)
