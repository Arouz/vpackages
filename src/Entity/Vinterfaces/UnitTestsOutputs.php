...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vinterfaces\UnitTestsOutputsRepository")
 * @ORM\Table(name="python_tests_outputs")
 */
class UnitTestsOutputs implements \JsonSerializable, \Vittascience\JsonDeserializer
{
    /** 
     * @ORM\Id
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Vittascience\Entity\Vinterfaces\UnitTests")
