...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vinterfaces\ExercisePythonFramesRepository")
 * @ORM\Table(name="python_exercise_frames")
 */
class ExercisePythonFrames implements \JsonSerializable, \Vittascience\JsonDeserializer
{
    /**
     * @ORM\Id
    ...
    private $id;
    /**
     * @ORM\ManyToOne(targetEntity="Vittascience\Entity\Vinterfaces\ExercisePython")
