...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vclassroom\UsersRestrictionsRepository")
 * @ORM\Table(name="classroom_users_restrictions")
 */
class UsersRestrictions implements \JsonSerializable, \Vittascience\JsonDeserializer
{
    /** 
     * @ORM\Id
    ...
    /**
     * @ORM\OneToOne(targetEntity="Vittascience\Entity\Vuser\User")
