...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vclassroom\ActivityLinkUserRepository")
 * @ORM\Table(name="classroom_activities_link_classroom_users")
 */
class ActivityLinkUser implements \JsonSerializable, \Vittascience\JsonDeserializer
{
