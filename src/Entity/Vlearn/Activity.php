...
/**
 * @ORM\Entity(repositoryClass="Vittascience\Repository\Vlearn\RepositoryActivity")
 * @ORM\Table(name="learn_activities")
 */
class Activity implements \JsonSerializable, \Vittascience\JsonDeserializer
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Vittascience\Entity\Vlearn\Folders")
